...
if __name__ == '__main__':
    ...
    resnet.layer0 = nn.Sequential(resnet.conv1, resnet.bn1, resnet.relu1, resnet.maxpool)
    ...
    print(query_feat_1.shape)  # [1, 256, 50, 50]  -- block1
    ...
    print(query_feat_4.shape)   # [1, 1024, 25, 25]  -- block4
